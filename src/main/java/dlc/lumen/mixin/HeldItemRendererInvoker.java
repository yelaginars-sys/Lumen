...
public interface HeldItemRendererInvoker {
   ...
   @Invoker("swingArm")
   void whylol$callSwingArm(float var1, float var2, MatrixStack var3, int var4, Arm var5);

   @Invoker("renderArmHoldingItem")
   void whylol$renderArmHoldingItem(MatrixStack var1, VertexConsumerProvider var2, int var3, float var4, float var5, Arm var6);

   @Invoker("renderMapInBothHands")
   void whylol$renderMapInBothHands(MatrixStack var1, VertexConsumerProvider var2, int var3, float var4, float var5, float var6);

   @Invoker("renderMapInOneHand")
   void whylol$renderMapInOneHand(MatrixStack var1, VertexConsumerProvider var2, int var3, float var4, Arm var5, float var6, ItemStack var7);

   @Invoker("renderItem")
   void whylol$renderItem(
