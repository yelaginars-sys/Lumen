...
public class LumenMenuScreen extends Screen implements QClient {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      float var18 = MathHelper.clamp(this.height * 0.5F - 47.0F + this.height * 0.035F, this.height * 0.16F, this.height - 86.0F);
      this.helper8(context, mouseX, mouseY, var13, var18 + (1.0F - var13) * 20.0F, var8);
      float var19 = var18 + 46.0F + 12.0F;
   ...
   private float helper8(DrawContext context, int mouseX, int mouseY, float r, float top, float dt) {
      ...
      if (!GlobalProfileAvatar.drawRounded(context, var12 + 6.0F, var13 + 2.0F, 18.0F, 18.0F, 9.0F, helper21(-1, (int)(255.0F * r)))) {
         Font var14 = helper19("icon", 12);
         if (var14 != null) {
            var14.draw(context.getMatrices(), "e", var12 + 10.0F, var13 + 4.0F, helper21(helper20(), (int)(255.0F * r)));
         }
      }

      Font var47 = helper19("suisse", 12);
      if (var47 != null) {
         var47.draw(
            context.getMatrices(),
